...
Ti štirje parametri so namreč prisotni v večini odzivnih funkcij, ki sestavljajo skelet vtičnika, tako da so hitro prepoznavne. % !TODO nekam napiši kaj so odzivne funkcije
    ...
    PF_LayerDef     *output )
{
    ...
    // luma slider
    PF_ADD_FLOAT_SLIDERX(   
        STR(StrID_LumaSlider_Param_Name),
        0, 1, 0, 1, 0.3,
        PF_Precision_THOUSANDTHS,
        0, 0,
        LUMATOL_DISK_ID);
    ...
    // sat slider
    PF_ADD_FLOAT_SLIDERX(   
        STR(StrID_SatSlider_Param_Name),
        0, 1, 0, 1, 0.3,
        PF_Precision_THOUSANDTHS,
        0, 0,
        SATTOL_DISK_ID);
