...
Tako so uporabljeni vizualni efekti naprimer v akcijskih filmih, na primer v filmu {\it Fire Brigade}, 1926, v katerem je prikazana dojenčica v goreči hiši. % !TODO prevod slovenski
...
Sicer je izhod enak linearni kombinaciji $\alpha A  $  \\ % !TODO linearna kombinacija
\end{tabular}
\end{center}
...
% !TODO kaj s tem stavkom in sekvenco !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
Vtičnik implementira odzive na ukazne izbirnike \texttt{PF\_Cmd\_ABOUT}, \path{PF\_Cmd\_GLOBAL\_SETUP}, \texttt{PF\_Cmd\_PARAMS\_SETUP} in \texttt{PF\_Cmd\_RENDER}.
...
Ukaz \path{suites.HandleSuite1()->host\_new\_handle( ... );} zahteva od gostitelja, naj mu varno rezervira željeno količino pomnilnika.
...
Vtičnik implementira odzive na ukazne izbirnike \verb!PF_Cmd_ABOUT!, \path{PF\_Cmd\_GLOBAL\_SETUP}, \verb!PF_Cmd_PARAMS_SETUP!,
\verb!PF_Cmd_RENDER! in \path{PF\_UPDATE\_PARAMS\_UI}.
Odziva na ukazna izbirnika \verb!PF_Cmd_ABOUT! in \path{PF\_Cmd\_GLOBAL\_SETUP} sta enaka kot pri vtičniku PixelRain, le da funkcija \verb!GlobalSetup! tudi
