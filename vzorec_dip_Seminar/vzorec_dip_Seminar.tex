...
Članek je osnoval nov algoritem za kompozicijo slike s pomočjo uvedbe kanala alpha (ang. {\it alpha chanell}), ki ponazarja prozornost piksla.
...
\footnotetext{2.5D je izraz, ki pomeni 2 dimenzionalen prostor, v katerem pa lahko posamezne 2D objekte razporedimo enega nad drugega v tretje smeri osi Z.}
